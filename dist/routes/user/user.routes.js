...
userRoute.post(user_routes_constant_1.USER_ROUTES.GENERATE_WORKOUT, role_guard_1.ROLE_GUARD.USER_GUARD, userController.generateWorkout);
userRoute.get(user_routes_constant_1.USER_ROUTES.GET_WORKOUT_PLANS, role_guard_1.ROLE_GUARD.USER_GUARD, userController.getWorkoutPlans);
userRoute.patch(user_routes_constant_1.USER_ROUTES.MARK_WORKOUT_DAY, role_guard_1.ROLE_GUARD.USER_GUARD, userController.markDayCompleted);
userRoute.patch(user_routes_constant_1.USER_ROUTES.MARK_WORKOUT_EXERCISE, role_guard_1.ROLE_GUARD.USER_GUARD, userController.markExerciseStatus);
userRoute.get(user_routes_constant_1.USER_ROUTES.GET_WORKOUT_PROGRESS, role_guard_1.ROLE_GUARD.USER_GUARD, userController.getWorkoutProgress);
