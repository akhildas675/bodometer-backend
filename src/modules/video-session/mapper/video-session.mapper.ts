...
export class VideoSessionMapper {
    static toVideoSessionResponseDto(
        ...
        return {
            ...
            actualDurationMinutes: videoSession.actualDurationMinutes,
            ...
            refundEligible: videoSession.refundEligible,
            refundStatus: videoSession.refundStatus,
            refundId: videoSession.refundId,
            refundRequestedAt: videoSession.refundRequestedAt,
            refundProcessedAt: videoSession.refundProcessedAt,
