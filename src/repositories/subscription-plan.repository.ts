import { ISubscriptionPlan, SubscriptionPlanModel } from "@/models/subscription-plan.model";
...
export default class SubscriptionPlanRepository extends BaseRepository<SubscriptionPlan, ISubscriptionPlan> implements ISubscriptionPlanRepository {
    constructor() {
    ...
    async getAllSubscriptionPlans(query: SubscriptionPlanQuery): Promise<GetAllSubscriptionPlansResponse> {
    ...
    async updateSubscriptionPlan(subscriptionPlanId: string, data: Partial<SubscriptionPlan>): Promise<SubscriptionPlan | null> {
        ...
        if (data.durationInDays !== undefined) updateFields.durationInDays = data.durationInDays;
    ...
    async toggleSubscriptionPlanStatus(subscriptionPlanId: string): Promise<SubscriptionPlan | null> {
