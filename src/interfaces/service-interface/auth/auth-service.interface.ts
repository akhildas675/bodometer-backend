import { ForgotPasswordDto, ForgotPasswordResponseDto, GoogleLoginDto, GoogleLoginResponseDto, LoginDto, LoginResponseDto, OtpVerifyDto, RegisterDto, RegisterResponseDto, ResetPasswordDto } from "../../../dto/auth/auth.dto";
