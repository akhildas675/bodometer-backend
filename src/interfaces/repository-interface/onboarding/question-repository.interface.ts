...
export interface IQuestionRepository {
  ...
  updateQuestion(questionId: string, data: Partial<OnboardingQuestion>): Promise<void>;
  ...
  getQuestionsByGroup(groupId: string, activeOnly?: boolean): Promise<OnboardingQuestion[]>;
}
