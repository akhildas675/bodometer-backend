...
export interface ISubscriptionPlanRepository {
    ...
    getAllSubscriptionPlans(query: SubscriptionPlanQuery): Promise<GetAllSubscriptionPlansResponse>;
    getSubscriptionPlanById(subscriptionPlanId: string): Promise<SubscriptionPlan | null>;
    updateSubscriptionPlan(subscriptionPlanId: string, data: Partial<SubscriptionPlan>): Promise<SubscriptionPlan | null>;
    toggleSubscriptionPlanStatus(subscriptionPlanId: string): Promise<SubscriptionPlan | null>;
